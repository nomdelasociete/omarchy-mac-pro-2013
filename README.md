...
- **Screen** — screensaver after 2.5 minutes. **No auto-lock.** Omarchy lock runs `hyprctl dpms disable` ~5 s later; on these FirePros that drops DisplayPort until a power-button reboot. Do not Super+Ctrl+L.
